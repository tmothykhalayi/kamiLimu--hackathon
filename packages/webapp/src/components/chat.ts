...
export const chatDefaultOptions: ChatComponentOptions = {
  ...
  promptSuggestions: [
    'Can you verify this election claim in Swahili?',
    'Is this forwarded WhatsApp message trustworthy?',
    'What signs suggest this image may be manipulated?',
  ],
  messages: [],
  strings: {
    ...
    chatInputPlaceholder: 'Paste a claim, caption, or message...',
    chatInputButtonLabel: 'Send for verification',
